...
export const AuroraEffect = ({slogan, text, btnText, location}:{slogan:string, text:string, btnText:string, location:string}) => {
    ...
    return(
        ...
        className="relative grid min-h-screen w-screen place-content-center overflow-hidden bg-gray-950 px-4 py-24 text-gray-200">
            <div className="flex flex-col items-center">
                <img className="h-30 w-80" src="/logoipsum-235.svg"/>
                <h1 className="max-w-6xl text-5xl font-medium text-center pb-3">{slogan}</h1>
